...
const resumeJobs =[{name:'Southern Airways Express', title:'IT Manager / System Administrator', local:'Lancaster, PA (remote)', from:'Apr 2021 - Present', duties:'Logistical management of all IT equipment in continental US. Plan, provision, deploy, orchestrate installation, and provide ongoing management for PCs, printers, networking equipment, mobile devices, and onsite infrastructure for 19 new stations and 65 global remote staff as footprint grew by 125% from 2021-2022. Maintain budget and schedule. Create complete tech deployment ‘kits’ for individuals and stations for easy drop-shipment. Coordinate movement of equipment for repair/replacement\n \nCreate documentation and SOPs for deployment and destruction of equipment. Facilitate updates and device replacement to maintain technical integrity, including hardware and software upgrades, in over 27 facilities. Improve security and performance. Spearhead company-wide migration of all devices to Windows 10/11\n \nMaintain accurate inventory and status of all devices through IT management systems, including Kaseya VSA, SnipeIT, TeamViewer, and IBM Maas360. Facilitate company-wide mobile migration of 150+ devices to new mobile provider, including initial deployment of new MDM. Create, adjust, and maintain user group policy, monitor application deployment, and secure missing devices within Maas360\n \nDesign, build, maintain, and provide user instruction of master digital library for pilots and ground crew for cross-use over iOS and Windows devices. Expedite deployment of mobile aeronautical chart system in the continental US for flight crew use in accordance with FAA and DOT standards. Assist with technical manual access with the addition of 5 new aircraft types to fleet. Coordinate with outside vendors to resolve issues for users and optimize the use of products\n \nWrite and deploy testing package for in-house Laravel PHP web application and implement PHPUnit tests. Isolate and fix internal bugs. Optimize and add features for ease of use. Perform user testing prior to deployment and implement web application for company use\n \nAdminister technical support for multiple end users, including proprietary software, reservation and flight management software, web applications, hardware issues, and Microsoft Office Suite/Microsoft Office Exchange. Escalate issues appropriately with third-party vendors, maintain accurate records, and document progress to follow through on all pending tickets\n'},
{name:'Lancaster City Alliance', title:'City Ambassador', local:'Lancaster, PA', from:'Jul 2020 - Jul 2021',
