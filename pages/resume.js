...
const relSkills =['Python3', 'PHP', 'JavaScript', 'Java', 'REACT', 'NEXTJS', 'REST APIs', 'Flutter', 'HTML/CSS', 'Automation Testing', 'Selenium Java', 'SQL Database', 'MySQL', 'PostgreSQL', 'SQLite', 'PgAdmin', 'phpMyAdmin', 'Version Control', 'Git / GitHub']
...
const resumeJobs =[{name:'Southern Airways Express', title:'IT Administrator', local:'Lancaster, PA (remote)', from:'April 2021-Present', duties:'•	Responsible for managing inventory, system, and network information for airport stations in the continental US, creating company-wide standard operating procedures for the provisioning of company equipment as pertains to the department and end-user needs\n \nFacilitate the update and replacement of station equipment across the continental US, upgrading hardware and software in 20 airport stations improving security and performance for agents and customers, refurbishing older equipment including hardware, backing up sensitive information, and properly preparing defunct equipment for disposal\n \nAssist in migration to new SaaS services, provide general help-desk and troubleshooting for end-users proprietary with software, Microsoft Office Online, monitor PC performance, and deploy update patching and machine maintenance as needed through VSA remote management systems, monitoring networks through firewalls and assisting in connetion issues on and off-site\n'},{name:'Lancaster City Alliance & Block by Block', title:'City Ambassador', local:'Lancaster, PA', from:'Aug 2020 - Present',
