...
const relSkills =['Inclusion advocate', 'Continuous, self-motivated learner', 'Solid communication skills', 'Cultivates a supportive, learning environment', 'Trauma-informed conflict resolution', 'Creative problem solving', 'Microsoft Office Suite / Microsoft Exchange', 'PHP / JavaScript / HTML / CSS', 'REACT / NEXTJS', 'OOP / Data Structures', 'SQL / MySQL / PostgreSQL Database', 'Version Control / Git / GitHub']
...
{name:'Lancaster City Alliance & Block by Block', title:'City Ambassador', local:'Lancaster, PA', from:'Jul 2020 - Present',
