...
const relSkills =['Python3', 'PHP', 'JavaScript', 'Java', 'REACT', 'NEXTJS', 'VERCEL', 'REST APIs', 'Flutter', 'HTML/CSS', 'Automation Testing', 'Selenium Java', 'SQL Database', 'MySQL', 'PostgreSQL', 'SQLite', 'PgAdmin', 'phpMyAdmin', 'Git / GitHub', 'Microsoft Office360', 'IBM Maas360', 'Kaseya VSA']
...
const resumeJobs =[{name:'Southern Airways Express', title:'IT Administrator', local:'Lancaster, PA (remote)', from:'April 2021-Present', duties:'Plan, provision, and deploy all tech-related equipment including onsite infrastructure for 12 new stations as the footprint grew in the continental US by 73% from 2021-2022\n \nMaintain accurate inventory and status of all company devices through IT management systems such as Kaseya VSA, SnipeIT, TeamViewer, and Maas360. Help facilitate company-wide mobile migration and initial deployment of new MDM. Create, adjust, and maintain user group policy within Maas360\n \nExpedite deployment of mobile aeronautical chart system in the continental US, provisioning and deploying 70+ devices. Design, build, maintain, and provide user instruction of master digital library for pilots and ground agents for cross-use over iOS and Windows 10 devices. Assisted with technical manual access through the addition of 5 new aircraft types\n \nFacilitate updates and replacements of all tech equipment, upgrade hardware and software in over 20 facilities improving security and performance for agents and customers. Spearheaded company-wide upgrade to Windows 10\n \nAssist with building of in-house Laravel PHP web application by building out application test directory and implementing PHPUnit tests. Isolate and fix internal bugs. Optimize and add features for ease of use. Perform user testing prior to deployment and implement web app into company use\n \nProvide help-desk and troubleshooting for end-users including proprietary reservation and flight management software, Microsoft Office Online, monitor PC performance, deploy update patching and machine maintenance through VSA remote management systems, monitor networks, and assist in connection issues on and off-site coordinating with ISP’s when needed\n'},
