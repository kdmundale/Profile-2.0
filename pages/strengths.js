...
const strengths = [{title:'I listen', section:"Patient, attentive listening reveals what is needed to resolve a situation. Remaining open and engaged in every discussion not only reinforces confidence between collaborators and clients, but saves time and resources as well."},
